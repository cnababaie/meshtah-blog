    ...
    return (
        <div>
            <div className="all-posts md:my-16 md:mx-64 p-8 bg-white/70 md:rounded-lg shadow-md">
                <h2 className="text-2xl font-bold mb-4">مقالات</h2>
                        ...
                        <div key={post.id} className="card border rounded-lg hover:shadow-2xl transition-shadow relative">
                            <Link href={post.url}>
                                ...
                                <img 
                                    ...
                                    className="inline-block md:max-w-[40%] h-[50%] object-cover"
                                />

                                <div className='md:inline-block sm:hidden max-w-[60%] text-black align-top px-4 py-12 text-lg h-full bg-white'>
                                    <p>
                                        {post.description}
                                    </p>
