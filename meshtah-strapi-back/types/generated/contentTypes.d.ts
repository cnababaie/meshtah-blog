...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    OriginalPublishedYear: Schema.Attribute.BigInteger &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID & Schema.Attribute.Required;
    source: Schema.Attribute.Component<'source.source', false>;
    translators: Schema.Attribute.Relation<'oneToMany', 'api::writer.writer'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    writers: Schema.Attribute.Relation<'oneToMany', 'api::writer.writer'>;
  };
}
